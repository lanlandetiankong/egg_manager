...
public class EggFuncActionNameConstant {
    ...
    public static class Prefix {
        ...
        public final static String QUERY_ONE_BY_ID = "根据id查询";
        ...
        public final static String CREATE_OPER = "新增";
        public final static String UPDATE_OPER = "更新";
        ...
        public final static String UPLOAD_EXCEL = "上传Excel";
        public final static String UPLOAD_IMG = "上传图片";
        public final static String EXCEL_EXPORT_CHECK = "导出已选";
        public final static String EXCEL_EXPORT_ALL = "导出所有";
        public final static String EXCEL_IMPORT_DATA = "导入数据";
    }
    ...
    public static class Suffix {
        ...
        public final static String QUERY_ONE_BY_ID = "";
        ...
        public final static String CREATE_OPER = "";
        public final static String UPDATE_OPER = "";
        ...
        public final static String UPLOAD_EXCEL = "";
        public final static String UPLOAD_IMG = "";

        public final static String EXCEL_EXPORT_CHECK = "";
        public final static String EXCEL_EXPORT_ALL = "";
        public final static String EXCEL_IMPORT_DATA = "";
    }
