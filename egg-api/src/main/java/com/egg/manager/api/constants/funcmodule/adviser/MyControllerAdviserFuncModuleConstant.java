package com.egg.manager.api.constants.funcmodule.adviser;
 ...
 * @date 2020/10/21
 */
public class MyControllerAdviserFuncModuleConstant extends EggBaseFuncModuleNameConstant {
    protected static final String KEY_FUNC_MODULE_NAME = emailSendRecord;
