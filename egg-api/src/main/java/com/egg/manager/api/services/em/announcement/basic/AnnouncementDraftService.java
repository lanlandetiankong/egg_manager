...
public interface AnnouncementDraftService extends IService<AnnouncementDraftEntity>, MyBaseMysqlService<AnnouncementDraftEntity, AnnouncementDraftMapper, AnnouncementDraftVo> {
     ...
     * @return WebResult
     */
    WebResult dealQueryPageByDtos(CurrentLoginUserInfo loginUserInfo, WebResult result, List<QueryField> queryFieldList, AntdvPaginationBean<AnnouncementDraftDto> paginationBean,
