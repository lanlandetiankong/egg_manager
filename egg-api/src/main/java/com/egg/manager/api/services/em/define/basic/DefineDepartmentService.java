...
public interface DefineDepartmentService extends IService<DefineDepartmentEntity>, MyBaseMysqlService<DefineDepartmentEntity, DefineDepartmentMapper, DefineDepartmentVo> {
     ...
     * @return
     */
    WebResult dealQueryPageByDtos(CurrentLoginUserInfo loginUserInfo, WebResult result, List<QueryField> queryFieldList, AntdvPaginationBean<DefineDepartmentDto> paginationBean,
