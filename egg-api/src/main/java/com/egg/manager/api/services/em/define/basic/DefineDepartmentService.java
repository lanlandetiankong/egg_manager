...
public interface DefineDepartmentService extends IService<DefineDepartmentEntity>, MyBaseMysqlService<DefineDepartmentEntity, DefineDepartmentMapper, DefineDepartmentVo> {
     ...
     * @return
     */
    MyCommonResult<DefineDepartmentVo> dealQueryPageByDtos(CurrentLoginUserInfo loginUserInfo, MyCommonResult<DefineDepartmentVo> result, List<QueryFormFieldBean> queryFieldBeanList, AntdvPaginationBean<DefineDepartmentDto> paginationBean,
     ...
     * @return
     */
    List<CommonTreeSelect> getTreeSelectChildNodes(CurrentLoginUserInfo loginUserInfo, Long rootId, List<DefineDepartmentEntity> allDepartments);
     ...
     * @return
     */
    List<CommonTreeSelect> getTreeSelectChildNodesWithRoot(CurrentLoginUserInfo loginUserInfo, Long rootId, List<DefineDepartmentEntity> allDefineDepartmentEntities);
