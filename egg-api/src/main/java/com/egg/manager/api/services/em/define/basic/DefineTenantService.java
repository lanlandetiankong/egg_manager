...
public interface DefineTenantService extends IService<DefineTenantEntity>, MyBaseMysqlService<DefineTenantEntity, DefineTenantMapper, DefineTenantVo> {
     ...
     * @return
     */
    WebResult dealQueryPageByDtos(CurrentLoginUserInfo loginUserInfo, WebResult result, List<QueryField> queryFieldList, AntdvPaginationBean<DefineTenantDto> paginationBean,
