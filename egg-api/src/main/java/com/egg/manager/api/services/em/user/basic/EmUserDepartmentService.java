 ...
 * @date 2020/10/20
 */
public interface EmUserDepartmentService extends IService<EmUserDepartmentEntity>, MyBaseMysqlService<EmUserDepartmentEntity, EmUserDepartmentMapper, EmUserDepartmentVo> {
