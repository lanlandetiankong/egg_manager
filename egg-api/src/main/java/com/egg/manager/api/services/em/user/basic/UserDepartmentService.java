...
public interface UserDepartmentService extends IService<UserDepartmentEntity>, MyBaseMysqlService<UserDepartmentEntity, UserDepartmentMapper, UserDepartmentVo> {
     ...
     * @return
     */
    MyCommonResult<UserDepartmentVo> dealQueryPageByEntitys(CurrentLoginUserInfo loginUserInfo, MyCommonResult<UserDepartmentVo> result, List<QueryFormFieldBean> queryFormFieldBeanList, AntdvPaginationBean<UserDepartmentEntity> paginationBean,
     ...
     * @return
     */
    MyCommonResult<UserDepartmentVo> dealQueryPageByDtos(CurrentLoginUserInfo loginUserInfo, MyCommonResult<UserDepartmentVo> result, List<QueryFormFieldBean> queryFieldBeanList, AntdvPaginationBean<UserDepartmentDto> paginationBean,
                                                         List<AntdvSortBean> sortBeans);
     ...
     * @throws Exception
     */
    Integer dealCreate(CurrentLoginUserInfo loginUserInfo, UserDepartmentVo userDepartmentVo) throws Exception;
     ...
     * @throws Exception
     */
    Integer dealUpdate(CurrentLoginUserInfo loginUserInfo, UserDepartmentVo userDepartmentVo) throws Exception;
}
