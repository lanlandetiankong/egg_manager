...
public interface UserRoleService extends IService<UserRoleEntity>, MyBaseMysqlService<UserRoleEntity, UserRoleMapper, UserRoleVo> {
     ...
     * @return
     */
    MyCommonResult<UserRoleVo> dealQueryPageByEntitys(CurrentLoginUserInfo loginUserInfo, MyCommonResult<UserRoleVo> result, List<QueryFormFieldBean> queryFormFieldBeanList, AntdvPaginationBean<UserRoleEntity> paginationBean,
     ...
     * @return
     */
    MyCommonResult<UserRoleVo> dealQueryPageByDtos(CurrentLoginUserInfo loginUserInfo, MyCommonResult<UserRoleVo> result, List<QueryFormFieldBean> queryFieldBeanList, AntdvPaginationBean<UserRoleDto> paginationBean,
                                                   List<AntdvSortBean> sortBeans);
     ...
     * @throws Exception
     */
    Integer dealCreate(CurrentLoginUserInfo loginUserInfo, UserRoleVo userRoleVo) throws Exception;
     ...
     * @throws Exception
     */
    Integer dealUpdate(CurrentLoginUserInfo loginUserInfo, UserRoleVo userRoleVo) throws Exception;
