...
public interface OblUserDefCollectCategoryService extends MyBaseMysqlService<OblUserDefCollectCategoryEntity, OblUserDefCollectCategoryMapper, OblUserDefCollectCategoryVo> {
     ...
     * @return WebResult
     */
    WebResult dealQueryPageByDtos(CurrentLoginEmUserInfo loginUserInfo, WebResult result, QueryPageBean<OblUserDefCollectCategoryDto> queryPageBean);
     ...
     * @throws Exception
     */
    Integer dealCreate(CurrentLoginEmUserInfo loginUserInfo, OblUserDefCollectCategoryVo oblUserDefCollectCategoryVo) throws Exception;
     ...
     * @throws Exception
     */
    Integer dealUpdate(CurrentLoginEmUserInfo loginUserInfo, OblUserDefCollectCategoryVo oblUserDefCollectCategoryVo) throws Exception;
