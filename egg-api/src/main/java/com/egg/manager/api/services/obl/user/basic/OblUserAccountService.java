...
public interface OblUserAccountService extends MyBaseMysqlService<OblUserAccountEntity, OblUserAccountMapper, OblUserAccountVo> {
     ...
     * @return WebResult
     */
    WebResult dealQueryPageByDtos(CurrentLoginEmUserInfo loginUserInfo, WebResult result, QueryPageBean<OblUserAccountDto> queryPageBean);
     ...
     * @throws Exception
     */
    Integer dealCreate(CurrentLoginEmUserInfo loginUserInfo, OblUserAccountVo oblUserAccountVo) throws Exception;
     ...
     * @throws Exception
     */
    Integer dealUpdate(CurrentLoginEmUserInfo loginUserInfo, OblUserAccountVo oblUserAccountVo) throws Exception;
