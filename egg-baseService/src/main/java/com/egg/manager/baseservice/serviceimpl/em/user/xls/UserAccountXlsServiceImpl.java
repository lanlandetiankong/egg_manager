...
public class UserAccountXlsServiceImpl extends MyXlsBaseServiceImpl implements UserAccountXlsService {
    ...
    @Override
    public void dealCheckExportSingleWithTemplate2Web(CurrentLoginUserInfo loginUserInfo, HttpServletResponse response, DefineMenuEntity defineMenuEntity, AntdFileUploadBean fileUploadBean, Long[] checkIds) throws Exception {
