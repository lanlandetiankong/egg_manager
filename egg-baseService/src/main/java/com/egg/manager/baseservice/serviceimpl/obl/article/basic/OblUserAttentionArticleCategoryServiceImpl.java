...
public class OblUserAttentionArticleCategoryServiceImpl extends MyBaseMysqlServiceImpl<OblUserAttentionArticleCategoryMapper, OblUserAttentionArticleCategoryEntity, OblUserAttentionArticleCategoryVo>
    ...
    @Override
    public WebResult dealQueryPageByDtos(CurrentLoginEmUserInfo loginUserInfo, WebResult result, QueryPageBean<OblUserAttentionArticleCategoryDto> queryPage) {
    ...
    @Override
    public Integer dealCreate(CurrentLoginEmUserInfo loginUserInfo, OblUserAttentionArticleCategoryVo oblUserAttentionArticleCategoryVo) throws Exception {
    ...
    @Override
    public Integer dealUpdate(CurrentLoginEmUserInfo loginUserInfo, OblUserAttentionArticleCategoryVo oblUserAttentionArticleCategoryVo) throws Exception {
