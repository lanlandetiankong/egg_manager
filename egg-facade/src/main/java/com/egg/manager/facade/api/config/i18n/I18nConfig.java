package com.egg.manager.facade.api.config.i18n;
...
public class I18nConfig {
    ...
    @Value("${egg.i18n.cookie.name:i18nLocale}")
    private String cookieName;
    /**
     *
     */
    @Value("${egg.i18n.cookie.max.age:3600}")
    ...
    public LocaleResolver localeResolver() {
        ...
        resolver.setCookieMaxAge(maxAge);      // cookie有效时长，单位秒
        resolver.setCookieName(cookieName);  //设置存储的Cookie的name为Language
        return resolver;
    }
