package com.egg.manager.facade.persistence.commons.util.data.date;
...
public class MyDateUtil {
    ...
    public static int getIntervalDays(Date date, Date otherDate) {
        int num = -1;
        Date dateTmp = stringToDate(MyDateUtil.getDate(date),
                MyDateStyle.YYYY_MM_DD);
        Date otherDateTmp = stringToDate(MyDateUtil.getDate(otherDate),
                MyDateStyle.YYYY_MM_DD);
