 ...
 * @date 2020/10/20
 */
public interface EmUserDepartmentMapper extends MyEggMapper<EmUserDepartmentEntity> {
    /**
     * [分页搜索查询] - 用户&部门
     * @param page
     * @param queryFieldArr
     ...
     * @return
     */
    List<EmUserDepartmentDto> selectQueryPage(Page<EmUserDepartmentDto> page, @Param(EggMpSqlConst.PARAMOF_QUERY_FIELD_LIST) QueryFieldArr queryFieldArr, @Param(EggMpSqlConst.PARAMOF_SORT_MAP) AntdvSortMap sortMap);
