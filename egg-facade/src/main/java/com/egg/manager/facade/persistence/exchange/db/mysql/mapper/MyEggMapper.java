package com.egg.manager.facade.persistence.exchange.db.mysql.mapper;
...
public interface MyEggMapper<T> extends BaseMapper<T> {
     ...
     * @return
     */
    int batchDeleteByIdsWithModifyFill(@Param(Constants.COLLECTION) Collection<? extends Serializable> idList, @Param(EggMpSqlConst.PARAMOF_LOGIN_USER) EmUserAccountEntity loginUser);
     ...
     * @return
     */
    int deleteByIdWithModifyFill(@Param(EggMpSqlConst.COLUMN_FID) Serializable fid, @Param(EggMpSqlConst.PARAMOF_LOGIN_USER) EmUserAccountEntity loginUser);
