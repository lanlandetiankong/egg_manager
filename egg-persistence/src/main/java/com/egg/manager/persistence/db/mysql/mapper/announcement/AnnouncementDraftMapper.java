...
public interface AnnouncementDraftMapper extends BaseMapper<AnnouncementDraft> {
     ...
     * @return
     */
    List<AnnouncementDraftMysqlDto> selectQueryPage(Pagination page, @Param("queryFieldList") List<QueryFormFieldBean> queryFieldBeanList, @Param("sortFieldList") List<AntdvSortBean> sortBeans);
