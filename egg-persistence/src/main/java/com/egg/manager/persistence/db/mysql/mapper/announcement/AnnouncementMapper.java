...
public interface AnnouncementMapper extends BaseMapper<Announcement> {
     ...
     * @return
     */
    List<AnnouncementMysqlDto> selectQueryPage(Pagination page, @Param("queryFieldList") List<QueryFormFieldBean> queryFieldBeanList, @Param("sortFieldList") List<AntdvSortBean> sortBeans);
