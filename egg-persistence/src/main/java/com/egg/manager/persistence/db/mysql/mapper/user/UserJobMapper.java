...
public interface UserJobMapper extends BaseMapper<UserJob> {
     ...
     * @return
     */
    List<UserJobMysqlDto> selectQueryPage(Pagination page, @Param("queryFieldList") List<QueryFormFieldBean> queryFieldBeanList, @Param("sortFieldList") List<AntdvSortBean> sortBeans);
