...
public interface DefineDepartmentMapper extends MyEggMapper<DefineDepartmentEntity> {
     ...
     * @return
     */
    List<DefineDepartmentDto> selectQueryPage(Page<DefineDepartmentDto> page, @Param(EggMpSqlConst.PARAMOF_QUERY_FIELD_LIST) QueryFieldArr queryFieldArr, @Param(EggMpSqlConst.PARAMOF_SORT_MAP) AntdvSortMap sortMap);
