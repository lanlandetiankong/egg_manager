...
public interface DefineModuleMapper extends MyEggMapper<DefineModuleEntity> {
     ...
     * @return
     */
    List<DefineModuleDto> selectQueryPage(Page<DefineModuleDto> page, @Param(EggMpSqlConst.PARAMOF_QUERY_FIELD_LIST) QueryFieldArr queryFieldArr, @Param(EggMpSqlConst.PARAMOF_SORT_MAP) AntdvSortMap sortMap);
}
