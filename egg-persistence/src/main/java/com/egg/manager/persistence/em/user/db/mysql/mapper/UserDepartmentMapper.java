...
public interface UserDepartmentMapper extends MyEggMapper<UserDepartmentEntity> {
     ...
     * @return
     */
    List<Long> findAllIdByUserAccountId(@Param(EggMpSqlConst.PARAMOF_USER_ACCOUNT_ID) String userAccountId, @Param("filterEnable") boolean filterEnable);
     ...
     * @return
     */
    int batchUpdateStateByUserAccountId(@Param(EggMpSqlConst.PARAMOF_USER_ACCOUNT_ID) String userAccountId, @Param("departmentIdList") List<Long> departmentIdList, @Param("stateVal") Short stateVal
