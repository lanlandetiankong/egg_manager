...
public interface UserJobMapper extends MyEggMapper<UserJobEntity> {
     ...
     * @return
     */
    List<UserJobDto> selectQueryPage(Page<UserJobDto> page, @Param(EggMpSqlConst.PARAMOF_QUERY_FIELD_LIST) List<QueryField> queryFieldList, @Param(EggMpSqlConst.PARAMOF_SORT_MAP) AntdvSortMap sortMap);
