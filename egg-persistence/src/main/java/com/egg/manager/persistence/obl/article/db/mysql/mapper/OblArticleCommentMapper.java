...
/**
 * @author zhoucj
 * @description 文章评论表-Dao
 * @date 2020-11-30
 */
public interface OblArticleCommentMapper extends MyEggMapper<OblArticleCommentEntity> {
     ...
     * @return
     */
    List<OblArticleCommentDto> selectQueryPage(Page<OblArticleCommentDto> page, @Param(EggMpSqlConst.PARAMOF_QUERY_FIELD_LIST) QueryFieldArr queryFieldArr, @Param(EggMpSqlConst.PARAMOF_SORT_MAP) AntdvSortMap sortMap);
}