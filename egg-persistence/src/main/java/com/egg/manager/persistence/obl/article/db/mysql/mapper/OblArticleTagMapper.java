 ...
 * @date 2020-11-30
 */
public interface OblArticleTagMapper extends MyEggMapper<OblArticleTagEntity> {
     ...
     * @return
     */
    List<OblArticleTagDto> selectQueryPage(Page<OblArticleTagDto> page, @Param(EggMpSqlConst.PARAMOF_QUERY_FIELD_LIST) QueryFieldArr queryFieldArr, @Param(EggMpSqlConst.PARAMOF_SORT_MAP) AntdvSortMap sortMap);
}