 ...
 * @date 2020-12-02
 */
public interface OblContentLikeRecordMapper extends MyEggMapper<OblContentLikeRecordEntity> {
     ...
     * @return
     */
    List<OblContentLikeRecordDto> selectQueryPage(Page<OblContentLikeRecordDto> page, @Param(EggMpSqlConst.PARAMOF_QUERY_FIELD_LIST) QueryFieldArr queryFieldArr, @Param(EggMpSqlConst.PARAMOF_SORT_MAP) AntdvSortMap sortMap);
}