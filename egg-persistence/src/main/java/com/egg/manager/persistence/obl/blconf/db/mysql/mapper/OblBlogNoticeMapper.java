...
/**
 * @author zhoucj
 * @description 博客通知表-Dao
 * @date 2020-11-30
 */
public interface OblBlogNoticeMapper extends MyEggMapper<OblBlogNoticeEntity> {
     ...
     * @return
     */
    List<OblBlogNoticeDto> selectQueryPage(Page<OblBlogNoticeDto> page, @Param(EggMpSqlConst.PARAMOF_QUERY_FIELD_LIST) QueryFieldArr queryFieldArr, @Param(EggMpSqlConst.PARAMOF_SORT_MAP) AntdvSortMap sortMap);
}