...
public class AnnouncementDraftMysqlTransfer extends MyBaseMysqlTransfer {
    ...
    public static AnnouncementDraftMysqlVo transferDtoToVo(AnnouncementDraftMysqlDto announcementDraftDto, Map<String, AnnouncementTag> announcementTagMap) {
        ...
        announcementDraftVo.setCreateUser(UserAccountMysqlTransfer.transferEntityToVo(announcementDraftDto.getCreateUser()));
        announcementDraftVo.setLastModifyer(UserAccountMysqlTransfer.transferEntityToVo(announcementDraftDto.getLastModifyer()));
        return announcementDraftVo;
    }
    ...
    public static List<AnnouncementDraftMysqlVo> transferDtoToVoList(List<AnnouncementDraftMysqlDto> announcementDraftDtos, Map<String, AnnouncementTag> announcementTagMap) {
        if (announcementDraftDtos == null) {
            return null;
        } else {
            List<AnnouncementDraftMysqlVo> list = new ArrayList<>();
            for (AnnouncementDraftMysqlDto announcementDraftDto : announcementDraftDtos) {
