...
public class AnnouncementMysqlTransfer extends MyBaseMysqlTransfer {
    ...
    public static AnnouncementMysqlVo transferDtoToVo(AnnouncementMysqlDto announcementDto, Map<String, AnnouncementTag> announcementTagMap) {
        ...
        announcementVo.setCreateUser(UserAccountMysqlTransfer.transferEntityToVo(announcementDto.getCreateUser()));
        announcementVo.setLastModifyer(UserAccountMysqlTransfer.transferEntityToVo(announcementDto.getLastModifyer()));
        return announcementVo;
    }

    public static List<AnnouncementMysqlVo> transferDtoToVoList(List<AnnouncementMysqlDto> announcementDtos, Map<String, AnnouncementTag> announcementTagMap) {
        if (announcementDtos == null) {
            return null;
        } else {
            List<AnnouncementMysqlVo> list = new ArrayList<>();
            for (AnnouncementMysqlDto announcementDto : announcementDtos) {
