...
public class DefineJobMysqlTransfer extends MyBaseMysqlTransfer {
    ...
    public static DefineJobMysqlVo transferDtoToVo(DefineJobMysqlDto defineJobDto) {
        ...
        defineJobVo.setCreateUser(UserAccountMysqlTransfer.transferEntityToVo(defineJobDto.getCreateUser()));
        defineJobVo.setLastModifyer(UserAccountMysqlTransfer.transferEntityToVo(defineJobDto.getLastModifyer()));
        return defineJobVo;
    }
    ...
    public static List<DefineJobMysqlVo> transferDtoToVoList(List<DefineJobMysqlDto> defineJobDtos) {
        if (defineJobDtos == null) {
            return null;
        } else {
            List<DefineJobMysqlVo> list = new ArrayList<>();
            for (DefineJobMysqlDto defineJobDto : defineJobDtos) {
