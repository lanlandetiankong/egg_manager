...
public class DefineMenuMysqlTransfer extends MyBaseMysqlTransfer {
    ...
    public static DefineMenuMysqlVo transferDtoToVo(DefineMenuMysqlDto defineMenuDto) {
        ...
        defineMenuVo.setParentMenu(DefineMenuMysqlTransfer.transferDtoToVo(defineMenuDto.getParentMenuDto()));
        ...
        defineMenuVo.setCreateUser(UserAccountMysqlTransfer.transferEntityToVo(defineMenuDto.getCreateUser()));
        defineMenuVo.setLastModifyer(UserAccountMysqlTransfer.transferEntityToVo(defineMenuDto.getLastModifyer()));
        return defineMenuVo;
    }
    ...
    public static List<DefineMenuMysqlVo> transferDtoToVoList(List<DefineMenuMysqlDto> defineMenuDtos) {
        if (defineMenuDtos == null) {
            return null;
        } else {
            List<DefineMenuMysqlVo> list = new ArrayList<>();
            for (DefineMenuMysqlDto defineMenuDto : defineMenuDtos) {
