...
public class DefinePermissionMysqlTransfer extends MyBaseMysqlTransfer {
    ...
    public static DefinePermissionMysqlVo transferEntityToVo(DefinePermissionMysqlDto definePermissionDto) {
        ...
        definePermissionVo.setCreateUser(UserAccountMysqlTransfer.transferEntityToVo(definePermissionDto.getCreateUser()));
        definePermissionVo.setLastModifyer(UserAccountMysqlTransfer.transferEntityToVo(definePermissionDto.getLastModifyer()));
        return definePermissionVo;
    }
    ...
    public static List<DefinePermissionMysqlVo> transferDtoToVoList(List<DefinePermissionMysqlDto> definePermissionDtos) {
        if (definePermissionDtos == null) {
            return null;
        } else {
            List<DefinePermissionMysqlVo> list = new ArrayList<>();
            for (DefinePermissionMysqlDto definePermissionDto : definePermissionDtos) {
