...
public class DefineModuleMysqlTransfer extends MyBaseMysqlTransfer {
    ...
    public static DefineModuleMysqlVo transferDtoToVo(DefineModuleMysqlDto defineModuleDto) {
    ...
    public static List<DefineModuleMysqlVo> transferDtoToVoList(List<DefineModuleMysqlDto> defineModuleDtos) {
        if (defineModuleDtos == null) {
            return null;
        } else {
            List<DefineModuleMysqlVo> list = new ArrayList<>();
            for (DefineModuleMysqlDto defineModuleDto : defineModuleDtos) {
