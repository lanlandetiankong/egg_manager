...
import com.egg.manager.persistence.pojo.dto.mysql.role.RoleMenuMysqlDto;
...
public class RoleMenuMysqlTransfer extends MyBaseMysqlTransfer {
    ...
    public static RoleMenuMysqlVo transferDtoToVo(RoleMenuMysqlDto roleMenuDto) {
        if (roleMenuDto == null) {
            return null;
        }
        RoleMenuMysqlVo roleMenuVo = new RoleMenuMysqlVo();
    ...
    public static List<RoleMenuMysqlVo> transferDtoToVoList(List<RoleMenuMysqlDto> roleMenuDtos) {
        if (roleMenuDtos == null) {
            return null;
        } else {
            List<RoleMenuMysqlVo> list = new ArrayList<>();
            for (RoleMenuMysqlDto roleMenuDto : roleMenuDtos) {
