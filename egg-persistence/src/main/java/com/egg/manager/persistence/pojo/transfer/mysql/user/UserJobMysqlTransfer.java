...
public class UserJobMysqlTransfer extends MyBaseMysqlTransfer {
    ...
    public static UserJobMysqlVo transferDtoToVo(UserJobMysqlDto userJobDto) {
        if (userJobDto == null) {
            return null;
        }
        UserJobMysqlVo userJobVo = new UserJobMysqlVo();
    ...
    public static List<UserJobMysqlVo> transferDtoToVoList(List<UserJobMysqlDto> userJobDtos) {
        if (userJobDtos == null) {
            return null;
        } else {
            List<UserJobMysqlVo> list = new ArrayList<>();
            for (UserJobMysqlDto userJobDto : userJobDtos) {
