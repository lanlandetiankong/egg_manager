...
public class UserRoleMysqlTransfer extends MyBaseMysqlTransfer {
    ...
    public static UserRoleMysqlVo transferDtoToVo(UserRoleMysqlDto userRoleDto) {
        if (userRoleDto == null) {
            return null;
        }
        UserRoleMysqlVo userRoleVo = new UserRoleMysqlVo();
    ...
    public static List<UserRoleMysqlVo> transferDtoToVoList(List<UserRoleMysqlDto> userRoleDtos) {
        if (userRoleDtos == null) {
            return null;
        } else {
            List<UserRoleMysqlVo> list = new ArrayList<>();
            for (UserRoleMysqlDto userRoleDto : userRoleDtos) {
