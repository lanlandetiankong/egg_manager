...
public class UserTenantMysqlTransfer extends MyBaseMysqlTransfer {
    ...
    public static UserTenantMysqlVo transferDtoToVo(UserTenantMysqlDto userTenantDto) {
    ...
    public static List<UserTenantMysqlVo> transferDtoToVoList(List<UserTenantMysqlDto> userTenantDtos) {
        if (userTenantDtos == null) {
            return null;
        } else {
            List<UserTenantMysqlVo> list = new ArrayList<>();
            for (UserTenantMysqlDto userTenantDto : userTenantDtos) {
