package com.egg.manager.em.web.controller.emctl.user.login;
...
import com.egg.manager.facade.persistence.em.user.pojo.verification.login.EmLoginAccountVerifyO;
...
public class EmUserLoginController extends BaseController {
    ...
    public WebResult doLoginCheckByAccount(HttpServletRequest request, LoginAccountVo loginAccountVo,
        ...
        try {
            ...
            throw new MyLoginFailureException(e);
        }
        return result;
    }
