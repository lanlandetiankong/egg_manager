...
@RestController
@RequestMapping("/oblCtl/article/oblUserAttentionArticleCategory")
public class OblUserAttentionArticleCategoryController extends BaseController {
    ...
    @EmPcWebQueryLog(fullPath = "/oblCtl/article/oblUserAttentionArticleCategory/queryDtoPage")
    ...
    @EmPcWebQueryLog(fullPath = "/oblCtl/article/oblUserAttentionArticleCategory/queryOneById")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/article/oblUserAttentionArticleCategory/createByForm")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/article/oblUserAttentionArticleCategory/updateByForm")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/article/oblUserAttentionArticleCategory/batchDeleteByIds")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/article/oblUserAttentionArticleCategory/deleteById")
