...
@RestController
@RequestMapping("/oblCtl/article/oblUserDefCollectCategory")
public class OblUserDefCollectCategoryController extends BaseController {
    ...
    @EmPcWebQueryLog(fullPath = "/oblCtl/article/oblUserDefCollectCategory/queryDtoPage")
    ...
    @EmPcWebQueryLog(fullPath = "/oblCtl/article/oblUserDefCollectCategory/queryOneById")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/article/oblUserDefCollectCategory/createByForm")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/article/oblUserDefCollectCategory/updateByForm")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/article/oblUserDefCollectCategory/batchDeleteByIds")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/article/oblUserDefCollectCategory/deleteById")
