...
@Api(value = "API-用户表")
@RestController
@RequestMapping("/oblCtl/user/oblUserAccount")
public class OblUserAccountController extends BaseController {
    ...
    @OblPcWebQueryLog(fullPath = "/oblCtl/user/oblUserAccount/queryDtoPage")
    ...
    @OblPcWebQueryLog(fullPath = "/oblCtl/user/oblUserAccount/queryOneById")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/user/oblUserAccount/createByForm")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/user/oblUserAccount/updateByForm")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/user/oblUserAccount/batchDeleteByIds")
    @ApiOperation(value = "批量逻辑删除->用户表", response = WebResult.class, httpMethod = HttpMethodConstant.POST)
    @ApiImplicitParams({
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/user/oblUserAccount/deleteById")
    @ApiOperation(value = "逻辑删除->用户表", response = WebResult.class, httpMethod = HttpMethodConstant.POST)
    @ApiImplicitParams({
