...
@RestController
@RequestMapping("/oblCtl/user/oblUserCalculateInfo")
public class OblUserCalculateInfoController extends BaseController {
    ...
    @EmPcWebQueryLog(fullPath = "/oblCtl/user/oblUserCalculateInfo/queryDtoPage")
    ...
    @EmPcWebQueryLog(fullPath = "/oblCtl/user/oblUserCalculateInfo/queryOneById")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/user/oblUserCalculateInfo/createByForm")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/user/oblUserCalculateInfo/updateByForm")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/user/oblUserCalculateInfo/batchDeleteByIds")
    ...
    @OblPcWebOperationLog(fullPath = "/oblCtl/user/oblUserCalculateInfo/deleteById")
