...
@RestController
@RequestMapping("/emUserAppRelated")
public class EmUserAppRelatedController extends BaseController {
    ...
    @OblPcWebOperationLog(fullPath = "/emUserAppRelated/batchDeleteByIds")
    @ApiOperation(value = "批量伪删除->app用户关联表", response = WebResult.class, httpMethod = HttpMethodConstant.POST)
    @ApiImplicitParams({
    ...
    @OblPcWebOperationLog(fullPath = "/emUserAppRelated/deleteById")
    @ApiOperation(value = "伪删除->app用户关联表", response = WebResult.class, httpMethod = HttpMethodConstant.POST)
    @ApiImplicitParams({
