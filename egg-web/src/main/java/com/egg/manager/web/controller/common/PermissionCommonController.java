...
public class PermissionCommonController extends BaseController {
    ...
    public MyCommonResult<DefinePermission> doGetAllPermissionTypeEnumList(HttpServletRequest request) {
        MyCommonResult<DefinePermission> result = MyCommonResult.gainQueryResult(DefinePermission.class, AnnouncementFuncModuleConstant.Success.queryEnumList);
        try {
    ...
    public MyCommonResult doGetAllRoleTypeEnumList(HttpServletRequest request) {
        MyCommonResult<FrontSelectBean> result = MyCommonResult.gainQueryResult(FrontSelectBean.class,AnnouncementFuncModuleConstant.Success.queryEnumList);
        try {
