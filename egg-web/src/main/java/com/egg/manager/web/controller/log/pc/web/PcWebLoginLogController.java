...
public class PcWebLoginLogController extends BaseController {
    ...
    public WebResult doGetDataPage(HttpServletRequest request,@QueryPage(tClass = PcWebLoginLogMgo.class) QueryPageBean<PcWebLoginLogMgo> queryPageBean,
        ...
        AntdvPage<PcWebLoginLogMgo> pageBean = pcWebLoginLogMgoService.doFindPage(loginUserInfo, queryPageBean);
