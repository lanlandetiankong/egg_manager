...
import com.egg.manager.api.constants.funcmodule.controllers.user.UserJobFuncModuleConstant;
...
public class UserJobController extends BaseController {
    ...
    public MyCommonResult<UserJobVo> doGetAllUserAccouts(HttpServletRequest request, String queryObj, String paginationObj, String sortObj
        ...
        try {
            ...
            //取得 分页配置
            AntdvPaginationBean<UserJob> paginationBean = this.parsePaginationJsonToBean(paginationObj,UserJob.class);
            //取得 排序配置
