...
public class UserTenantController extends BaseController{
    ...
    @OperLog(action="查询 [用户与租户关联] 列表",description = "查询 [用户与租户关联] 列表",fullPath = "/user/user_tenant/getAllUserTenants")
    ...
    @OperLog(action="批量删除 [用户与租户关联] ",description = "根据 [用户与租户关联] id批量删除 [用户与租户关联] ",fullPath = "/user/user_tenant/batchDelUserTenantByIds")
    ...
    @OperLog(action="删除 [用户与租户关联] ",description = "根据 [用户与租户关联] id删除 [用户与租户关联] ",fullPath = "/user/user_tenant/delOneUserTenantByIds")
